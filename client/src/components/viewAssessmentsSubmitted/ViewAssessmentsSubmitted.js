...
import "../viewAssignmentSubmitted/ViewAssignmentSubmitted.css";
        ...
        <div className="view-assignments my-5 p-3">
          <div className="view-assignment__buttons">
            <button
              ...
              onClick={() => this.filterSubmittedAssignments()}
            >
            ...
            <button
              ...
              onClick={() => this.filterNotSubmitteedAssign()}
            >
              {this.props.pastSub}
              <i className="fas fa-eye ml-2" aria-hidden="true"></i>
            </button>
